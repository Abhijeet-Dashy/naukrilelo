  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-primaryText">
      ...
      <div className="sticky top-6 z-50 w-full px-4 sm:px-6 lg:px-8 pointer-events-none">
        <header className="pointer-events-auto mx-auto max-w-5xl flex h-14 items-center justify-between px-6 border border-border bg-surface/60 backdrop-blur-sm rounded-full shadow-lg shadow-black/40">
          <div className="flex items-center space-x-6">
            <Link to="/" className="font-bold text-lg tracking-tight">Naukri Lelo</Link>
          ...
          <div className="flex items-center space-x-6">
            <a href="https://github.com/liquidslr/leetcode-company-wise-problems/" target="_blank" rel="noreferrer" className="text-sm font-medium text-secondaryText hover:text-primaryText transition-colors flex items-center">
